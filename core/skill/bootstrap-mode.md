...
**`agent-policy.yaml`** — must put the boundary-backend definition files (e.g., `src/test/java/**/architecture/**`) in red zone. Verify it parses against `core/schema/agent-policy.schema.json`.
